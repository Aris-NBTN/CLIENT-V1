const O=(n,t={})=>{const l=n.BlockManager,o=t.stylePrefix,e=`${o}row-aris`,s=`${o}cell-aris`,f=t.labelRow,v=t.labelColumn,p=a=>{const d=[];for(let h in a){let r=a[h];const u=r instanceof Array||r instanceof Object;r=u?JSON.stringify(r):r,d.push(`${h}=${u?`${r}`:`"${r}"`}`)}return d.length?`${d.join(" ")}`:""},A="flex-basis",j=3,y=1,R=1,w={tl:0,tc:0,tr:0,cl:0,cr:0,bl:0,br:0,minDim:y},S={...w,cr:1,cl:1,bc:1,keyWidth:A,currentUnit:R,minDim:y,step:j,onMove:(a,d,{resizer:h})=>{const r=a.parentElement;if(!r)return;const u=Array.from(r.children),k=u.indexOf(a),M=k===0,P=k===u.length-1;if(h==="cr"&&!P){const m=u[k+1],H=a.offsetWidth,W=m.offsetWidth,b=d.right;a.style.width=`${H+b}px`,m.style.width=`${W-b}px`}else if(h==="cl"&&!M){const m=u[k-1],H=a.offsetWidth,W=m.offsetWidth,b=d.left;a.style.width=`${H-b}px`,m.style.width=`${W+b}px`}}},B={class:e,"data-gjs-droppable":`.${s}`,"data-gjs-resizable":w,"data-gjs-custom-name":f},C={class:s,"data-gjs-draggable":`.${e}`,"data-gjs-resizable":S,"data-gjs-custom-name":v,"data-gjs-unstylable":["width"],"data-gjs-stylable-require":["flex-basis"]},V=[`.${e}`,`.${s}`];n.on("selector:add",a=>V.indexOf(a.getFullName())>=0&&a.set("private",1)),n.on("block:drag:stop",a=>{const d=a==null?void 0:a.parent();d&&d.getClasses().includes(s)&&a.setStyle({width:"100%",display:"block",padding:"0","min-height":"55px","max-height":"100%","max-width":"100%"})});const E="Flexbox",i="Basic",g=p(B),x=p(C),c=`
    .${e} {
      display: flex;
  ...
  `;l.add("flexbox",{label:E,category:i,media:`
    ...
    `,...t.flexboxBlock})},L=(n,t={})=>{const l={flexboxBlock:{},stylePrefix:"",labelRow:"Row",labelColumn:"Column",...t};O(n,l)},T=(n,t={})=>{const l=n.BlockManager,o=t.stylePrefix,e=`${o}row-aris-2`,s=`${o}cell-aris-2`,f=t.labelRow,v=t.labelColumn,p=i=>{const g=[];for(let x in i){let c=i[x];const $=c instanceof Array||c instanceof Object;c=$?JSON.stringify(c):c,g.push(`${x}=${$?`'${c}'`:`"${c}"`}`)}return g.length?` ${g.join(" ")}`:""},j={tl:0,tc:0,tr:0,cl:0,cr:0,bl:0,br:0,minDim:10},y={class:e,"data-gjs-droppable":`.${s}`,"data-gjs-resizable":j,"data-gjs-custom-name":f},R={class:s,"data-gjs-draggable":`.${e}`,"data-gjs-resizable":{bc:1,keyHeight:"flex-basis",minDim:10,step:1,currentUnit:"px",unitHeight:"px",tl:0,tr:0,bl:0,br:0},"data-gjs-custom-name":v,"data-gjs-unstylable":["width"],"data-gjs-stylable-require":["flex-basis"]},w=[`.${e}`,`.${s}`];n.on("selector:add",i=>w.indexOf(i.getFullName())>=0&&i.set("private",1)),n.on("block:drag:stop",i=>{const g=i==null?void 0:i.parent();g&&g.getClasses().includes(s)&&i.setStyle({width:"auto",height:"234px",padding:"0","min-height":"55px","max-height":"100%","max-width":"100%"})}),n.on("component:clone",i=>{console.log(i)});const S="Basic",B=p(y),C=p(R),V=`
    .${e} {
      display: flex;
      flex-direction: column;
      padding: 10px;
