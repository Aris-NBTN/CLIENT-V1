import{t as A,W as j,a3 as G,f as $,U as K,j as c,h as k,r as F}from"./index-CcDScCIj.js";import{G as W}from"./index-BaK9lv42.js";import{f as P}from"./fileApi-BF5u9JAm.js";import{R as Z,C}from"./row-Bv7HvGZ0.js";const U=a=>{a.I18n.addMessages({vi:{assetManager:{addButton:"Thêm ảnh",inputPlh:"Nhập link ảnh: http://image.jpg",modalTitle:"Chọn ảnh",uploadTitle:"Kéo thả file vào đây hoặc click để upload"},blockManager:{labels:{column1:"1 Cột",column2:"2 Cột",column3:"3 Cột","column3-7":"2 Cột (1 nhỏ 1 lớn)",image:"Ảnh",text:"Văn bản",link:"Liên kết",video:"Video",map:"Bản đồ"},categories:{Basic:"Khối cơ bản",Extra:"Khối mở rộng",Blog:"Khối Blog",Contact:"Khối liên hệ",Content:"Khối nội dung",CTA:"Khối CTA",Commerce:"Khối thương mại",Features:"Khối tính năng",Footer:"Khối chân trang",Header:"Khối tiêu đề",Gallery:"Khối thư viện","3D Model":"Mô hình 3D",Hero:"Khối Hero",Pricing:"Khối giá",Statistics:"Khối thống kê",Steps:"Khối bước",Team:"Khối nhóm",Testimonials:"Khối chứng nhận",Layout:"Khối bố cục"}},domComponents:{names:{"":"Box",wrapper:"Body",text:"Text",comment:"Bình luận",image:"Hình ảnh",video:"Video",label:"Nhãn",link:"Liên kết",map:"Google Map",tfoot:"Chân bảng biểu",tbody:"Thân bảng biểu",thead:"Đầu bảng biểu",table:"Bảng biểu",Row:"Hàng",Cell:"Cột"}},deviceManager:{device:"",devices:{desktop:"Máy tính",tablet:"Máy tính bảng",mobileLandscape:"Di động nằm ngang",mobilePortrait:"Di động dọc"}},panels:{buttons:{titles:{Preview:"Xem thử",fullscreen:"Toàn màn hình","sw-visibility":"X-ray","export-template":"Xem mã","open-sm":"Trình soạn thảo style","open-tm":"Thiết lập","open-layers":"Trình soạn thảo lớp","open-blocks":"Mở khối"}}},selectorManager:{label:"Classes",selected:"Đã chọn",emptyState:"- Trạng thái -",states:{hover:"Lướt qua",active:"Chạm","nth-of-type(2n)":"Chẵn/Lẻ"}},styleManager:{empty:"Chọn 1 phần tử trước khi sử dụng",layer:"Lớp",fileButton:"Hình ảnh",sectors:{general:"Chung",layout:"Bố cục",typography:"Kiểu chữ",decorations:"Trang trí",extra:"Mở rộng",flex:"Flex",dimension:"Kích thước"},properties:{"text-shadow-h":"X","text-shadow-v":"Y","text-shadow-blur":"Mờ","text-shadow-color":"Màu","box-shadow-h":"X","box-shadow-v":"Y","box-shadow-blur":"Mờ","box-shadow-spread":"Spread","box-shadow-color":"Màu","box-shadow-type":"Loại","border-top-left-radius-sub":"Trên góc trái","border-top-right-radius-sub":"Trên góc phải","border-bottom-right-radius-sub":"Dưới góc phải","border-bottom-left-radius-sub":"Dưới góc trái","transform-rotate-x":"Rotate X","transform-rotate-y":"Rotate Y","transform-rotate-z":"Rotate Z","transform-scale-x":"Scale X","transform-scale-y":"Scale Y","transform-scale-z":"Scale Z","transition-property-sub":"Thuộc tính","transition-duration-sub":"Duration","transition-timing-function-sub":"Timing","background-image-sub":"Hình ảnh","background-repeat-sub":"Lặp lại","background-position-sub":"Vị trí","background-attachment-sub":"Đính kèm","background-size-sub":"Kích thước"}},traitManager:{empty:"Chọn 1 thành phần trước khi sử dụng",label:"Cấu hình",traits:{labels:{id:"Id",alt:"Mô tả",title:"Tiêu đề",href:"Liên kết",address:"Địa chỉ",mapType:"Bản đồ",zoom:"Phóng to",target:"Mở cửa sổ"},options:{target:{false:"Cửa sổ hiện tại",_blank:"Cửa sổ mới"},mapType:{roadMap:"Đường bộ",sateLlite:"Vệ tinh"}}}},storageManager:{recover:"Bạn có muốn khôi phục những thay đổi chưa được lưu?"}}})},J=(a,l)=>{const n={id:"1",label:"File 3D"},r={id:"2",label:"Ánh sáng",open:!1},s={id:"3",label:"Bóng đỗ",open:!1},p={id:"4",label:"Tự động xoay",open:!1},h={id:"5",label:"Môi trường",open:!1},f={id:"7",label:"Skybox",open:!1},y={id:"8",label:"Tùy chọn",open:!0},b={id:"9",label:"Camera",open:!1};a.Components.addType("Model 3D",{model:{defaults:{name:"Model 3D",tagName:"model-viewer",droppable:!1,resizable:!0,script:function(){},traits:[{name:"option-file-glb",type:"option-file",category:y},{name:"input-src-glb",type:"input-file",label:"Link file",category:n},{name:"src",type:"input-file-glb",category:n},{label:"Camera",name:"camera-model",type:"camera-model",category:b},{label:"Min FOV",name:"camera-min-fov",type:"camera-min-fov",category:b},{label:"Max FOV",name:"camera-max-fov",type:"camera-max-fov",category:b},{label:"Độ sáng",name:"exposure",type:"range-light",category:r},{name:"input-src-environment",type:"input-src-environment",label:"Link file",category:h},{label:"Môi trường",name:"environment-image",type:"environment",category:h},{name:"add-environment",type:"add-environment",category:h},{label:"Skybox",name:"skybox",type:"skybox",category:f},{label:"Distance",name:"floor-skybox",type:"floor-skybox",category:f},{label:"Cường độ",name:"shadow-intensity",type:"shadow-intensity",category:s},{label:"Độ mềm",name:"shadow-softness",type:"shadow-softness",category:s},{label:"Vị trí",name:"shadow-placement",type:"shadow-placement",category:s},{label:"Góc xoay",name:"rotation-per-second",type:"rotation-per-second",category:p},{label:"Độ trễ",name:"delay-rotate",type:"delay-rotate",category:p}],attributes:{"camera-controls":!0,"touch-action":"pan-y",src:"http://localhost:8082/uploads/3d/file3d/1.glb"},style:{width:"100%",height:"345px",display:"block"}}}}),a.TraitManager.addType("camera-model",{noLabel:!0,createInput({component:e}){const i=document.createElement("div");return i.classList.add("flex","items-center","justify-center"),i.innerHTML=`
      ...
      >
    `,t},onEvent({component:e}){var t=this.el.querySelector("#fov").value;e.addAttributes({"max-field-of-view":`${t}deg`})}}),a.TraitManager.addType("camera-min-fov",{createInput({component:e}){var u,o,g,v;const i=parseInt((o=(u=e.view.el)==null?void 0:u.getAttribute("max-field-of-view"))==null?void 0:o.replace("deg",""))||60,t=parseInt((v=(g=e.view.el)==null?void 0:g.getAttribute("min-field-of-view"))==null?void 0:v.replace("deg",""))||30,d=document.createElement("div");return d.classList.add("flex","items-center","justify-center","flex-col"),d.innerHTML=`
      <input 
        id="fov" 
        type="range" 
        ...
        class="w-full h-2 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
      >
    `,d},onEvent({component:e}){var t=this.el.querySelector("#fov").value;e.addAttributes({"min-field-of-view":`${t}deg`})}}),a.TraitManager.addType("option-file",{noLabel:!0,createInput({component:e}){const i=document.createElement("div");i.classList.add("flex","items-center","justify-center"),i.innerHTML=`
      ...
      `;const t=e.view.el;return t[Object.getOwnPropertySymbols(t).find(u=>u.description==="scene")],i.querySelector("#a").addEventListener("click",()=>{a.DomComponents.addComponent({tagName:"div",classes:["aaa"],components:`
        ...
        <style>
            ...
            @keyframes pulse_3011 {
              ...
              `})}),i},onEvent({component:e}){}}),a.TraitManager.addType("loader",{createInput(){const e=[{text:"Neutral",value:"neutral"},{text:"Legacy",value:"legacy"},{text:"Spruit Sunrise",value:""},{text:"Creek Regional",value:""}];let i="";e.forEach(d=>{i+=`<option value="${d.value}">${d.text}</option>`});const t=document.createElement("div");return t.innerHTML=`
      <select id="loader">
        ${i}
      </select>
    ...
    `,t},onEvent({component:e}){function i(d){return/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)[a-zA-Z0-9]+([\-\.]{1}[a-zA-Z0-9]+)*(\:[0-9]+)?(\/.*)?$/.test(d)}const t=this.el.querySelector("#file");i(t.value)?fetch(t.value,{method:"HEAD"}).then(d=>{d.ok==!0?(e.addAttributes({src:t.value}),A("File đã được cập nhập")):j("File không tồn tại hoặc đã bị xóa !","Vui lòng nhập lại !")}).catch(()=>{j("Có lỗi xảy ra","Vui lòng thử lại !")}):j("Link không hợp lệ","Vui lòng nhập lại !")}}),a.TraitManager.addType("input-file-glb",{noLabel:!0,createInput(){const e=document.createElement("div");return e.innerHTML=`
      <input id="file-glb" type="file" class="input-file" accept=".glb, .gltf"/>
    `,e},onEvent({component:e}){G("3d","Đang giảm kích thước..");const i=this.el.querySelector("#file-glb");if(i.files[0]){let t=new FormData;t.append("file3d",i.files[0]),P.file3D(t).then(d=>{A("3d","Đã cập nhập file","Vui lòng lưu trang !"),e.addAttributes({src:`${$}/uploads/3d/${d.file}`})}).catch(()=>j("Có lỗi xảy ra"))}}}),a.TraitManager.addType("range-light",{createInput({component:e}){const i=e.view.el.getAttribute("exposure")||1,t=document.createElement("div");return t.classList.add("flex","items-center","justify-center","flex-col"),t.innerHTML=`
      <input 
        id="exposure" 
        type="range" 
        ...
        class="w-full h-2 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
      >
    `,t},onEvent({component:e}){var t=this.el.querySelector("#exposure").value;e.addAttributes({exposure:t})}}),a.TraitManager.addType("environment",{createInput({component:e}){const i=e.view.el.getAttribute("environment-image")||"neutral",t=document.createElement("div");t.classList.add("flex","items-center","justify-center");const d=[{text:"Neutral",value:"neutral"},{text:"Legacy",value:"legacy"},{text:"Spruit Sunrise",value:"https://modelviewer.dev/shared-assets/environments/spruit_sunrise_1k_HDR.jpg"},{text:"Creek Regional",value:"https://modelviewer.dev/shared-assets/environments/whipple_creek_regional_park_04_1k.hdr"},{text:"Custom",value:"custom",disabled:!0}];let u="";return d.forEach(o=>{u+=`<option value="${o.value}" ${o.value===i?"selected":""} ${o.disabled?"disabled":""}>${o.text}</option>`}),t.innerHTML=`
      <select id="environment">
        ${u}
      </select>
    `,t},onEvent({component:e}){const i=this.el.querySelector("#environment"),t=e.view.el.getAttribute("skybox-image");var d=i.value;t!=null&&e.addAttributes({"skybox-image":d}),(d=="neutral"||d=="legacy")&&e.removeAttributes("skybox-image"),e.addAttributes({"environment-image":d})}}),a.TraitManager.addType("add-environment",{noLabel:!0,createInput(){const e=document.createElement("div");return e.innerHTML=`
        <input id="file-environment" type="file" class="input-file" accept=".png, .jpg"/>
      `,e},onEvent({component:e}){const i=this.el.querySelector("#file-environment"),t=e.view.el.getAttribute("skybox-image");if(i.files[0]){let d=new FormData;d.append("ev",i.files[0]),settingGlbApi.environment(d).then(u=>{t&&(console.log("skyboxValue",t),e.addAttributes({"skybox-image":`${$}/uploads/3d/environment/${u.link}`})),e.addAttributes({"environment-image":`${$}/uploads/3d/environment/${u.link}`})})}}}),a.TraitManager.addType("input-src-environment",{createInput({component:e}){const i=e.view.el.getAttribute("environment-image")||"",t=document.createElement("div");return t.innerHTML=`
      <input id="file" type="text" placeholder="Nhập link môi trường" value="${i}" />
    `,t},onEvent({component:e}){function i(d){return/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)[a-zA-Z0-9]+([\-\.]{1}[a-zA-Z0-9]+)*(\:[0-9]+)?(\/.*)?$/.test(d)}const t=this.el.querySelector("#file");i(t.value)?fetch(t.value,{method:"HEAD"}).then(d=>{d.ok==!0?(e.addAttributes({"environment-image":t.value}),A("File đã được cập nhập")):j("File không tồn tại hoặc đã bị xóa !","Vui lòng nhập lại !")}).catch(()=>{j("Có lỗi xảy ra","Vui lòng thử lại !")}):j("Link không hợp lệ","Vui lòng nhập lại !")}}),a.TraitManager.addType("skybox",{createInput({component:e}){const i=!!e.view.el.getAttribute("skybox-image"),t=document.createElement("div");t.classList.add("flex","items-center","justify-center");const d=[{text:"Tắt",value:!1},{text:"Bật",value:!0}];let u="";return d.forEach(o=>{u+=`<option value="${o.value}" ${o.value===i?"selected":""}>${o.text}</option>`}),t.innerHTML=`
      <select id="skybox">
        ${u}
      </select>
    `,t},onEvent({component:e}){const i=this.el.querySelector("#skybox"),t=e.view.el.getAttribute("environment-image");var d=i.value;if(t=="neutral"||t=="legacy"){e.removeAttributes("skybox-image"),j("Môi trường mặc định không hỗ trợ skybox !","Vui lòng chọn môi trường khác !");return}d==="true"?e.addAttributes({"skybox-image":t}):e.removeAttributes("skybox-image")}}),a.TraitManager.addType("floor-skybox",{createInput({component:e}){const i=e.view.el.getAttribute("skybox-height")||1,t=document.createElement("div");return t.classList.add("flex","items-center","justify-center","flex-col"),t.innerHTML=`
      <input 
        id="floor-skybox" 
        type="range" 
    ...
    `,t},onEvent({component:e}){var t=this.el.querySelector("#shadow-intensity").value;e.addAttributes({"shadow-intensity":t})}}),a.TraitManager.addType("shadow-softness",{createInput({component:e}){const i=e.view.el.getAttribute("shadow-softness")||1,t=document.createElement("div");return t.classList.add("flex","items-center","justify-center","flex-col"),t.innerHTML=`
      <input 
        ...
        class="w-full h-2 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
      >
    `,t},onEvent({component:e}){var t=this.el.querySelector("#shadow-softness").value;e.addAttributes({"shadow-softness":t})}}),a.TraitManager.addType("shadow-placement",{createInput({component:e}){const i=e.view.el.getAttribute("ar-placement")||"floor",t=document.createElement("div");t.classList.add("flex","items-center","justify-center","flex-col");const d=[{text:"Mặt đất",value:"floor"},{text:"Bức tường",value:"wall"}];let u="";return d.forEach(o=>{u+=`<option value="${o.value}" ${o.value===i?"selected":""} ${o.disabled?"disabled":""}>${o.text}</option>`}),t.innerHTML=`
      <select id="placement">
        ${u}
      </select>
    `,t},onEvent({component:e}){var t=this.el.querySelector("#placement").value;e.addAttributes({"ar-placement":t})}}),a.TraitManager.addType("delay-rotate",{createInput({component:e}){const i=e.view.el.getAttribute("auto-rotate-delay")||3e3,t=document.createElement("div");return t.classList.add("flex","items-center","justify-center","flex-col"),t.innerHTML=`
      ...
      >
    `,t},onEvent({component:e}){const i=!!e.view.el.getAttribute("auto-rotate");var d=this.el.querySelector("#rotateDelay").value;i||e.addAttributes({"auto-rotate":!0}),e.addAttributes({"auto-rotate-delay":d})}}),a.TraitManager.addType("rotation-per-second",{createInput({component:e}){const i=e.view.el.getAttribute("rotation-per-second")||30,t=document.createElement("div");return t.classList.add("flex","items-center","justify-center","flex-col"),t.innerHTML=`
      <input 
        ...
        class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"
      >
    `,t},onEvent({component:e}){const i=!!e.view.el.getAttribute("auto-rotate");var d=this.el.querySelector("#rotation-per-second").value;i||e.addAttributes({"auto-rotate":!0}),e.addAttributes({"rotation-per-second":`${d}deg`})}}),a.Blocks.add("model-3D",{label:"3D",media:`<svg width="100%" viewBox="0 0 24 24">
    ...
    `,content:{type:"block-link"},category:"Basic"}),a.Components.addType("block-link",{model:{defaults:{name:"Link Block",tagName:"a",resizable:!0,traits:[{type:"title-link",name:"title-link",label:"title"},{type:"href-next",name:"href",label:"New href"},{type:"target-link",name:"target-link",label:"Mở cửa sổ"}],style:{width:"100%",height:"345px",display:"block",cursor:"pointer"}}}}),a.TraitManager.addType("target-link",{createInput({component:l}){const n=l.view.el.getAttribute("target")||"",r=document.createElement("div");return r.innerHTML=`
      ...
      `,r},onEvent({component:l}){const n=this.el.querySelector("#link");l.addAttributes({href:n.value})}})},Y=a=>{a.Components.addType("Slider",{model:{defaults:{name:"Slider",resizable:!0,droppable:!1,copyable:!1,traits:[{name:"navigation",type:"select",options:[{id:"no",label:"Không có"},{id:"yes",label:"Có"}],default:"yes",placeholder:"Chọn ẩn/hiển nút điều hướng",changeProp:!0}],navigation:"yes","script-props":["navigation"],script:function(l){let n=null;function r(s){n&&n.destroy(!0,!0);const p={pagination:{el:".swiper-pagination",dynamicBullets:!0}};s==="yes"&&(p.navigation={nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}),n=new Swiper(".mySwiper",p)}r(l.navigation)},components:`
        <style>
          .swiper {
            width: 100%;
            height: 100%;
    ...
    `,content:{type:"Slider"},category:"Basic"})},Q=(a,l)=>{a.Components.addType("Masonry",{model:{defaults:{droppable:!1,resizable:!0,copyable:!1,script:function(){var n=document.querySelector(".grid");new Packery(n,{itemSelector:".grid-item"})},content:`
         <iframe
            name="masonry"
            style="width: 100%; height: 100dvh;"
            src="${K}/admin/page-custom/masonry/${l}" 
            title="ARIS">
          </iframe>
    ...
    `,content:{type:"Masonry"},category:"Basic"})},ee=a=>{a.Components.addType("HeaderLayout",{model:{defaults:{droppable:!1,copyable:!1,resizable:!0,script:function(){((r,s)=>{const p=document.getElementById(r),h=document.getElementById(s);p.addEventListener("click",()=>{h.classList.toggle("show-menu"),p.classList.toggle("show-icon")})})("nav-toggle-2","nav-menu-2")},components:`
        <style>
    ...
    <header class="headerr">
      ...
      `,content:{type:"HeaderLayout"},category:"Layout"}),a.DomComponents.addType("link",{model:{defaults:{traits:[{type:"title-link",name:"title-link",label:"title"},{type:"href-next",name:"href",label:"New href"},{type:"href-next-link",name:"href-link",label:"Link file"},{type:"target-link",name:"target-link",label:"Mở cửa sổ"}]}}}),a.TraitManager.addType("target-link",{createInput({component:n}){const r=n.view.el.getAttribute("target")||"",s=document.createElement("div");return s.innerHTML=`
        <select id="target-link">
          <option value="" ${r===""?"selected":""}>Cửa sổ trang hiện tại</option>
          <option value="_blank" ${r==="_blank"?"selected":""}>Cửa sổ trang mới</option>
        </select>
      `,s},onEvent({component:n}){const r=this.el.querySelector("#target-link");r.value==="_blank"?(n.addAttributes({target:r.value}),console.log(n.view.el)):n.removeAttributes("target")}}),a.TraitManager.addType("title-link",{createInput({component:n}){const r=n.view.el.getAttribute("title")||"",s=document.createElement("div");return s.innerHTML=`
        <input id="title" type="text" placeholder="Nhập tiêu đề" value="${r}" />
      `,s},onEvent({component:n}){const r=this.el.querySelector("#title");n.addAttributes({title:r.value})}}),a.TraitManager.addType("href-next-link",{createInput({component:n}){const r=n.view.el.getAttribute("href")||"",s=document.createElement("div");return s.innerHTML=`
        <input id="link" type="text" value="${r}" />
      `,s},onEvent({component:n}){const r=this.el.querySelector("#link");n.addAttributes({href:r.value})}}),a.Commands.add("addMenu",{run(n){const r=n.getSelected();if(r){const s=r.find(".nav__list")[0];if(s){const p=n.DomComponents.addComponent({tagName:"li",classes:["dropdown__item","menu-dropdown"],components:`
            <div class="nav__link">
              <h4 class="menu-text">New</h4> 
              <ul class="dropdown__menu"></ul>
            </div>
            `});s.append(p)}}}}),a.Commands.add("addNavLink",{run(n){var f,y;const r=n.getSelected(),s=r.find(".dropdown__menu")[0],p=(y=(f=r==null?void 0:r.view)==null?void 0:f.el)==null?void 0:y.querySelector(".dropdown__arrow"),h=()=>{const b=n.DomComponents.addComponent({tagName:"li",classes:["dropdown__subitem"],components:`
          <div class="dropdown__link">
            <h4 class="menu-text">Items</h4> 
              <ul class="dropdown__submenu dropdown-aris">
            </ul>
          </div>
          `});s.append(b)};if(p==null){const b=n.DomComponents.addComponent({tagName:"div",classes:["dropdown__arrow"],components:'<i class="ri-arrow-down-s-line"></i>'});h(),r.append(b)}else h()}}),a.Commands.add("addDropDownLink",{run(n){const r=n.getSelected(),s=r.find(".dropdown__submenu")[0],p=s.view.el.querySelectorAll("li").length,h=()=>{const f=n.DomComponents.addComponent({tagName:"li",components:`
            <a href="#" class="dropdown__sublink">
              <i class="ri-file-list-line"></i> 
              <h4 class="menu-text">Items</h4>
            </a>
          `});s.append(f)};if(p==0){console.log("countLi",p);const f=n.DomComponents.addComponent({tagName:"div",classes:["submenu-icon"],components:`
            <i class="ri-add-line dropdown__add"></i>
          `});r.append(f),h()}else h()}}),a.Commands.add("delMenu",{run(n){var h;const r=n.getSelected().view.el,s=(h=r==null?void 0:r.closest("li.dropdown__item"))==null?void 0:h.querySelector("ul.dropdown__menu"),p=n.getSelected();if(p){const f=p.parent();console.log(f.parent().parent()),f&&(f.remove(p),s&&(s.style.opacity="",s.style.top=""))}}}),a.Commands.add("del-sub-menu",{run(n){var f,y;const r=n.getSelected().view.el,s=n.getSelected(),p=(f=r==null?void 0:r.closest("li.dropdown__item"))==null?void 0:f.querySelector("ul.dropdown__menu"),h=(y=r==null?void 0:r.closest("li.dropdown__subitem"))==null?void 0:y.querySelector("ul.dropdown__submenu");if(s){const b=s.parent();b&&(b.remove(s),h.style.opacity="",h.style.top="",p.style.opacity="",p.style.top="")}}}),a.Commands.add("del-menu-cha",{run(n){const r=n.getSelected();if(r){const s=r.parent();console.log(s),s&&s.remove(r)}}});const l=(n,r,s,p)=>{var g,v;const h=n.view.el,f=n.get("toolbar"),y=h.classList[0],b=f.some(m=>m.id==="new-menu"),e=f.some(m=>m.id==="new-con"),i=f.some(m=>m.id==="del-menu"),t=f.some(m=>m.id==="del-menu-cha"),d=(g=h==null?void 0:h.closest("li.dropdown__item"))==null?void 0:g.querySelector("ul.dropdown__menu"),u=(v=h==null?void 0:h.closest("li.dropdown__subitem"))==null?void 0:v.querySelector("ul.dropdown__submenu"),o=f.filter(m=>m.command!=="tlb-delete"&&m.command!=="tlb-clone"&&m.command!=="tlb-move");switch(y){case"dropdown__sublink":if(!b){const m={label:'<svg viewBox="0 0 24 24"><path fill="currentColor" d="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z" /></svg>',id:"del-sub-menu",command:"del-sub-menu"};o.push(m),n.set("toolbar",o)}break;case"nav__link":if(!t){const m={label:'<svg viewBox="0 0 24 24"><path fill="currentColor" d="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z" /></svg>',id:"del-menu-cha",command:"del-menu-cha"};o.push(m)}if(!b){const m={label:'<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path fill="none" d="M0 0h24v24H0z"></path> <path d="M18 15l-.001 3H21v2h-3.001L18 23h-2l-.001-3H13v-2h2.999L16 15h2zm-7 3v2H3v-2h8zm10-7v2H3v-2h18zm0-7v2H3V4h18z"></path> </g> </g></svg>',id:"new-menu",command:"addNavLink"};o.push(m)}n.set("toolbar",o);break;case"dropdown__link":if(!i){const m={label:'<svg viewBox="0 0 24 24"><path fill="currentColor" d="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z" /></svg>',id:"del-menu",command:"delMenu"};o.push(m)}if(!e){const m={label:'<svg fill="#000000" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M2 3C.9 3 0 3.9 0 5v2c0 1.1.9 2 2 2h21c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 1h21c.563 0 1 .437 1 1v2c0 .563-.437 1-1 1H2c-.563 0-1-.437-1-1V5c0-.563.437-1 1-1zm0 17.5v2c0 .262.238.5.5.5h6.813l-1.157 1.125c-.48.497.28 1.157.688.72l2-2c.193-.187.193-.534 0-.72l-2-2c-.397-.397-1.14.268-.688.72L9.312 23H3v-1.5c0-.665-1-.644-1 0zm14-.5c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-2c0-1.1-.9-2-2-2zm0 1h12c.563 0 1 .437 1 1v2c0 .563-.437 1-1 1H16c-.563 0-1-.437-1-1v-2c0-.563.437-1 1-1zM2 12c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2h21c1.1 0 2-.9 2-2v-2c0-1.1-.9-2-2-2zm0 1h21c.563 0 1 .437 1 1v2c0 .563-.437 1-1 1H2c-.563 0-1-.437-1-1v-2c0-.563.437-1 1-1z"></path></g></svg>',id:"new-con",command:"addDropDownLink"};o.push(m)}n.set("toolbar",o);break;case"nav":if(!e){const m={label:'<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title></title> <g id="Complete"> <g data-name="add" id="add-2"> <g> <line fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="12" x2="12" y1="19" y2="5"></line> <line fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="5" x2="19" y1="12" y2="12"></line> </g> </g> </g> </g></svg>',id:"new-menu",command:"addMenu"};o.push(m)}n.set("toolbar",o);break}d&&(d.style.opacity=r,d.style.top=s),u&&(u.style.opacity=r,u.style.top=p)};a.on("component:selected",n=>{l(n,"1","60px","0")}),a.on("component:deselected",n=>{l(n,"","","0")})},te=a=>{a.Components.addType("FooterLayout",{model:{defaults:{droppable:!1,resizable:!0,copyable:!1,script:function(){},components:`
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        `,content:{type:"User"},category:"Layout"})},ne=a=>{infoApi.allInfo().then(l=>{let n="";l.social.forEach(r=>{n+=`
      ...
      `,content:{type:"Social"},category:"Layout"})}).catch(l=>{console.error("Error fetching data from API:",l)})},ie=a=>{a.Components.addType("Container",{model:{defaults:{resizable:!0,components:`
        ...
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3 19H1V18C1 16.1362 2.27477 14.5701 4 14.126M6 10.8293C4.83481 10.4175 4 9.30621 4 7.99999C4 6.69378 4.83481 5.58254 6 5.1707M21 19H23V18C23 16.1362 21.7252 14.5701 20 14.126M18 5.1707C19.1652 5.58254 20 6.69378 20 7.99999C20 9.30621 19.1652 10.4175 18 10.8293M10 14H14C16.2091 14 18 15.7909 18 18V19H6V18C6 15.7909 7.79086 14 10 14ZM15 8C15 9.65685 13.6569 11 12 11C10.3431 11 9 9.65685 9 8C9 6.34315 10.3431 5 12 5C13.6569 5 15 6.34315 15 8Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
        `,content:{type:"Container"},category:"Layout"})},re=a=>{a.Components.addType("ImgSlider",{model:{defaults:{droppable:!1,resizable:!0,copyable:!1,script:function(){setTimeout(()=>{var l=new Packery(".grid",{itemSelector:".grid-item",columnWidth:100});l.getItemElements().forEach(function(r){var s=new Draggabilly(r);l.bindDraggabillyEvents(s)});function n(){l.getItemElements().forEach(function(r,s){r.textContent=s+1})}l.on("layoutComplete",n),l.on("dragItemPositioned",n)},0)},components:`
        <style>
        </style>
    ...
    `,content:{type:"Products"},category:"Basic"})},le=a=>{a.Components.addType("Three.Js",{model:{defaults:{droppable:!1,resizable:!0,copyable:!1,traits:[{type:"text",name:"delay",placeholder:"Nhập số khoảng thời gian chuyển slide (ms)",changeProp:!0}],delay:"https://threejsfundamentals.org/threejs/resources/models/windmill/windmill.obj","script-props":["delay"],script:function(l){function n(){const r=document.querySelector("#c"),s=new THREE.WebGLRenderer({canvas:r}),p=45,h=2,f=.1,y=100,b=new THREE.PerspectiveCamera(p,h,f,y);b.position.set(0,10,20);const e=new THREE.OrbitControls(b,r);e.target.set(0,5,0),e.update();const i=new THREE.Scene;i.background=new THREE.Color("black");{const v=new THREE.TextureLoader().load("https://threejsfundamentals.org/threejs/resources/images/checker.png");v.wrapS=THREE.RepeatWrapping,v.wrapT=THREE.RepeatWrapping,v.magFilter=THREE.NearestFilter;const m=40/2;v.repeat.set(m,m);const w=new THREE.PlaneBufferGeometry(40,40),_=new THREE.MeshPhongMaterial({map:v,side:THREE.DoubleSide}),M=new THREE.Mesh(w,_);M.rotation.x=Math.PI*-.5,i.add(M)}{const m=new THREE.HemisphereLight(11657727,12155424,1);i.add(m)}{const v=new THREE.DirectionalLight(16777215,1);v.position.set(5,10,2),i.add(v),i.add(v.target)}const t=new THREE.OBJLoader2;t.loadMtl("https://threejsfundamentals.org/threejs/resources/models/windmill/windmill.mtl",null,o=>{t.setMaterials(o),t.load(l.delay,g=>{const v=g.detail.loaderRootNode;i.add(v)})});function d(o){const g=o.domElement,v=g.clientWidth,m=g.clientHeight,w=g.width!==v||g.height!==m;return w&&o.setSize(v,m,!1),w}function u(){if(d(s)){const o=s.domElement;b.aspect=o.clientWidth/o.clientHeight,b.updateProjectionMatrix()}s.render(i,b),requestAnimationFrame(u)}requestAnimationFrame(u)}n()},content:`
        <style>
        #c{
          width: 100%;
          height: 100%;
    ...
    <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 218.207 218.207" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <g> <path d="M214.31,27.276H3.897C1.743,27.276,0,29.019,0,31.172v27.276v77.931v50.655c0,2.154,1.743,3.897,3.897,3.897H214.31 c2.154,0,3.897-1.743,3.897-3.897v-50.655V58.448V31.172C218.207,29.019,216.464,27.276,214.31,27.276z M7.793,62.345h35.069 v70.138H7.793V62.345z M210.414,132.483h-11.69V62.345h11.69V132.483z M210.414,54.552h-15.586c-2.154,0-3.897,1.743-3.897,3.897 v77.931c0,2.154,1.743,3.897,3.897,3.897h15.586v42.862H7.793v-0.001v-42.862h38.966c2.154,0,3.897-1.743,3.897-3.897V58.448 c0-2.154-1.743-3.897-3.897-3.897H7.793V35.069h202.621V54.552z"></path> <circle cx="113" cy="163.655" r="7.793"></circle> <path d="M66.241,140.277h109.103c2.154,0,3.897-1.743,3.897-3.897V58.448c0-2.153-1.743-3.896-3.896-3.896H66.241 c-2.154,0-3.897,1.743-3.897,3.897v77.931C62.344,138.534,64.087,140.277,66.241,140.277z M70.138,62.345h101.31v70.138H70.138 V62.345z"></path> <rect x="66.241" y="159.759" width="11.69" height="7.793"></rect> <rect x="85.724" y="159.759" width="11.69" height="7.793"></rect> <rect x="128.586" y="159.759" width="11.69" height="7.793"></rect> <rect x="148.069" y="159.759" width="11.69" height="7.793"></rect> </g> </g> </g> </g></svg>
    `,content:{type:"Three.Js"},category:"Basic"})},de={model3d:J,imageLink:X,masonry:Q,header:ee,footer:te,user:ae,socical:ne,container:ie,slider:Y,imgSlider:re,threeJs:oe,products:se,test:le},ce=(a,l)=>{a.Panels.addButton("options",[{id:"link-page",className:"fa fa-link",attributes:{title:"Link"},command:"open-new-page",active:!1,togglable:!1}]),a.Commands.add("open-new-page",{run(n,r){l=="trang-chu"?window.open("/","_blank"):window.open(`/${l}`,"_blank")}})},pe=a=>{a.Panels.addButton("views",[{id:"open-code",attributes:{title:"Open Code"},className:"fa fa-file-code-o",command:"open-code",togglable:!1}])},me=a=>{a.Panels.addButton("options",[{id:"google-fonts",className:"fa-solid fa-font-case",attributes:{title:"Cài đặt kiểu chữ"},command:"open-fonts",active:!1}])},D={openPage:ce,openCode:pe,openGoogleFont:me},ue=()=>c.jsx(c.Fragment,{children:c.jsx("div",{className:"gjs-one-bg",style:{height:40},children:c.jsxs(Z,{children:[c.jsxs(C,{className:"overflow-hidden",span:20,children:[c.jsxs("div",{className:"flex justify-between items-center p-2 border",style:{height:40},children:[c.jsx(k.Input,{active:!0,size:"default",style:{height:25}}),c.jsx(k.Input,{className:"float-right",active:!0,size:"default",style:{height:25}})]}),c.jsx("div",{className:"bg-white flex justify-center items-center",style:{height:"calc(100vh - 100px)"},children:c.jsxs("div",{"aria-label":"Orange and tan hamster running in a metal wheel",role:"img",className:"wheel-and-hamster",children:[c.jsx("div",{className:"wheel"}),c.jsx("div",{className:"hamster",children:c.jsxs("div",{className:"hamster__body",children:[c.jsxs("div",{className:"hamster__head",children:[c.jsx("div",{className:"hamster__ear"}),c.jsx("div",{className:"hamster__eye"}),c.jsx("div",{className:"hamster__nose"})]}),c.jsx("div",{className:"hamster__limb hamster__limb--fr"}),c.jsx("div",{className:"hamster__limb hamster__limb--fl"}),c.jsx("div",{className:"hamster__limb hamster__limb--br"}),c.jsx("div",{className:"hamster__limb hamster__limb--bl"}),c.jsx("div",{className:"hamster__tail"})]})}),c.jsx("div",{className:"spoke"})]})})]}),c.jsxs(C,{className:"border gjs-one-bg overflow-hidden",span:4,style:{height:"calc(100vh - 56px)"},children:[c.jsx("div",{className:"flex justify-center items-center p-2 border-b",style:{height:38},children:c.jsx(k.Button,{active:!0,block:!0,style:{height:25}})}),c.jsx("div",{className:"flex justify-center items-center p-2 border-b",style:{height:38},children:c.jsx(k.Button,{active:!0,block:!0,style:{height:25}})}),c.jsxs(Z,{className:"p-2",gutter:[12,12],children:[c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})}),c.jsx(C,{span:12,children:c.jsx(k.Image,{active:!0,style:{width:"100%"}})})]})]})]})})}),ye=({data:a,canvas:l,pluginss:n,plugins:r,pluginsOpts:s,savePage:p,slug:h,folder:f,configGrapeJs:y,height:b="100vh"})=>{const e=F.useRef(null),[i,t]=F.useState(!0),d=o=>{o.Panels.addButton("options",[{id:"save-page",className:"fa fa-upload",attributes:{title:"Public"},command:"save-page",active:!1,togglable:!1}]),o.Commands.add("save-page",{run(g,v){var m=g.getHtml().replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,""),w=g.getCss(),_=g.getJs();const M=g.getProjectData();p(M,{html:m,css:w,js:_})}})},u=o=>{e.current=o,de.masonry(o,h),D.openPage(o,h),o.loadProjectData(a),o.Components.addType("image",{model:{defaults:{name:"Ảnh",resizable:!0,droppable:!1,copyable:!0,traits:["alt"],attributes:{"data-fancybox":"gallery"}}}}),D.openPage(o,h),U(o),y(o),d(o),o.on("asset:open",()=>{const g=o.AssetManager;console.log(g)}),t(!1)};return c.jsxs(c.Fragment,{children:[i&&c.jsx(ue,{}),c.jsx(W,{className:"overflow-hidden",grapesjs:"https://unpkg.com/grapesjs",grapesjsCss:"https://unpkg.com/grapesjs/dist/css/grapes.min.css",onEditor:u,i18n:{locale:"vi"},plugins:n,options:{height:b,canvas:{scripts:l==null?void 0:l.scripts,styles:l==null?void 0:l.styles},plugins:r,pluginsOpts:s,storageManager:!1,undoManager:{trackSelection:!1},canvasCss:`
  ...
  `;n.add("flexbox",{label:m,category:w,media:`
    ...
    `,...l.flexboxBlock})},xe=(a,l={})=>{const n={flexboxBlock:{},stylePrefix:"",labelRow:"Row",labelColumn:"Column",...l};he(a,n)},ge=(a,l={})=>{const n=a.BlockManager,r=l.stylePrefix,s=`${r}row-aris-2`,p=`${r}cell-aris-2`,h=l.labelRow,f=l.labelColumn,y=w=>{const _=[];for(let M in w){let T=w[M];const z=T instanceof Array||T instanceof Object;T=z?JSON.stringify(T):T,_.push(`${M}=${z?`'${T}'`:`"${T}"`}`)}return _.length?` ${_.join(" ")}`:""},e={tl:0,tc:0,tr:0,cl:0,cr:0,bl:0,br:0,minDim:10},i={class:s,"data-gjs-droppable":`.${p}`,"data-gjs-resizable":e,"data-gjs-custom-name":h},t={class:p,"data-gjs-draggable":`.${s}`,"data-gjs-resizable":{bc:1,keyHeight:"flex-basis",minDim:10,step:1,currentUnit:"px",unitHeight:"px",tl:0,tr:0,bl:0,br:0},"data-gjs-custom-name":f,"data-gjs-unstylable":["width"],"data-gjs-stylable-require":["flex-basis"]},d=[`.${s}`,`.${p}`];a.on("selector:add",w=>d.indexOf(w.getFullName())>=0&&w.set("private",1)),a.on("block:drag:stop",w=>{const _=w==null?void 0:w.parent();_&&_.getClasses().includes(p)&&w.setStyle({width:"auto",height:"234px",padding:"0","min-height":"55px","max-height":"100%","max-width":"100%"})}),a.on("component:clone",w=>{console.log(w)});const u="Basic",o=y(i),g=y(t),v=`
    .${s} {
      display: flex;
      flex-direction: column;
      padding: 10px;
    ...
    `,category:u,attributes:{class:"gjs-fonts gjs-f-b2"},content:`
        <div ${o}>
          <div ${g}></div>
          <div ${g}></div>
        </div>
        ...
        `,...l.flexboxBlock})},ke=(a,l={})=>{const n={flexboxBlock:{},stylePrefix:"",labelRow:"Row-Row",labelColumn:"Column-Row",...l};ge(a,n)};export{de as B,ye as P,ue as S,ke as a,xe as p};
