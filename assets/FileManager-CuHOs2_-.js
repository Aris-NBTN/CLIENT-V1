...
.file-card-right-layer-footer {
  ...
  bottom: 0;
  right: 0;
}`);var ft=function(e){var n=e.localization,i=e.size,a=Y(n).status;return r.createElement(r.Fragment,null,r.createElement(nn,{color:"#f44336",size:i||65}),r.createElement("span",null," ",a.aborted))},mt=function(e){var n=e.height,i=n?typeof n=="number"?"".concat(n,"px"):n:"132px";return r.createElement(r.Fragment,null,r.createElement("div",{style:{width:"100%",height:i}}))},pt=function(e){var n=e.localization,i=e.size,a=Y(n).status;return r.createElement(r.Fragment,null,r.createElement(me,{color:"rgba(255,255,255,0.4)",style:{backgroundColor:"rgba(244, 67, 54, 0.8)",borderRadius:"50%"},size:i||65}),r.createElement("span",null," ",a.error))},gt=function(e){var n=e.onCancel,i=e.localization,a=e.size,t=Y(i).status;return r.createElement(r.Fragment,null,r.createElement(tn,{onClick:n,size:a||65}),r.createElement("span",null,t.preparing))},bt=function(e){var n=e.localization,i=e.size,a=Y(n).status;return r.createElement(r.Fragment,null,r.createElement(en,{color:"#4caf50",size:i||65}),r.createElement("span",null," ",a.success))};z(`text.files-ui-text-dynamic-loader {
  text-anchor: middle;
  font-size: 1em;
  fill: aliceblue;
...
.lds-colorbar .files-ui-text-default-loader {
  ...
  font-weight: 400;
  text-anchor: middle;
}`);var ht=function(e){var n=e.localization,i=e.size,a=e.onAbort,t=e.progress,l=Y(n).status;return r.createElement(r.Fragment,null,t!==void 0?r.createElement(xt,{size:70,x:35,y:35,radius:32,percentage:t,width:6,hidePerncentage:t===void 0||a!==void 0,onClick:a}):r.createElement(tn,{onClick:a,size:i||70}),r.createElement("span",null," ",l.uploading))};z(`.files-ui-file-card-upload-layer {
  width: 100px;
  height: 100%;
  color: rgba(255, 255, 255, 0.8);
  font-weight: 500;
...
.files-ui-file-item-status-container.file-status-loading .uploading-text p.percentage {
  font-weight: 500;
}`);var rn=function(e){var n=e.valid,i=e.uploadStatus,a=e.localization,t=e.style,l=Y(a).status;return i==="success"?r.createElement("div",{className:"files-ui-file-item-status-container file-status-ok",style:t},r.createElement(Ka,{color:"#4caf50",size:"small",className:"status-icon"}),l.success):i==="error"||i==="aborted"?r.createElement("div",{className:"files-ui-file-item-status-container file-status-error",style:t},r.createElement(et,{color:"#f44336",size:"semi-medium",className:"status-icon"}),l.error):n!=null?n?r.createElement("div",{className:"files-ui-file-item-status-container file-status-ok",style:t},r.createElement(en,{color:"#4caf50",size:"small",className:"status-icon"}),l.valid):r.createElement("div",{className:"files-ui-file-item-status-container file-status-error",style:t},r.createElement(nn,{color:"#f44336",size:"small",className:"status-icon"}),l.denied):r.createElement(r.Fragment,null)},Et=function(e){var n=e.valid,i=e.localization,a=e.onCloseInfo,t=e.uploadStatus,l=e.localName,o=e.sizeFormatted,s=e.localType,u=Y(i),c=u.fullInfoLayer,m=c.name,g=c.size,p=c.type;return r.createElement(r.Fragment,null,r.createElement("div",{className:"files-ui-file-mosaic-info-layer-header"},r.createElement(qa,{color:"rgba(255,255,255,0.8)",onClick:a,colorFill:"black"}),r.createElement(rn,{valid:n,uploadStatus:t,localization:i})),r.createElement("div",{className:"heading"},m),r.createElement("div",{className:"label"},l),r.createElement("div",{className:"heading"},g),r.createElement("div",{className:"label"},o),r.createElement("div",{className:"heading"},p),r.createElement("div",{className:"label"},s))};z(`.filesui-file-item-size {
  box-sizing: border-box;
  font-size: 0.7rem;
...
}`);var jt=function(e){var n=e.sizeFormatted;return r.createElement(r.Fragment,null,n&&r.createElement("div",{className:"filesui-file-item-size"},n))},Nt=function(e){var n=e.darkMode,i=e.deleteIcon,a=e.downloadIcon,t=e.imageIcon,l=e.infoIcon,o=e.onDelete,s=e.onDownload,u=e.onOpenInfo,c=e.onSee,m=e.onWatch,g=e.sizeFormatted,p=e.valid,b=e.videoIcon,h=e.localization,E=e.uploadStatus,k=e.isActive;return r.createElement(r.Fragment,null,r.createElement("div",{className:"file-mosaic-main-layer-header"},k&&i&&r.createElement(me,{className:n?"files-ui-file-icon dark-mode":"files-ui-file-icon",color:n?"#121212":"rgba(255,255,255,0.851)",onClick:o,size:"small",colorFill:"transparent"})),r.createElement("div",{className:"file-mosaic-main-layer-footer"},r.createElement("div",{className:"file-mosaic-footer-left"},r.createElement(rn,{valid:p,uploadStatus:E,localization:h}),k&&g&&r.createElement(jt,{sizeFormatted:g})),r.createElement("div",{className:"file-mosaic-footer-right"},k&&r.createElement(r.Fragment,null,t&&r.createElement(nt,{className:n?"files-ui-file-icon dark-mode":"files-ui-file-icon",color:n?"#121212":"rgba(255,255,255,0.851)",onClick:c,size:"small"}),b&&r.createElement(Ja,{className:n?"files-ui-file-icon dark-mode":"files-ui-file-icon",color:n?"#121212":"rgba(255,255,255,0.851)",onClick:m,size:"small"}),a&&r.createElement(Qa,{className:n?"files-ui-file-icon dark-mode":"files-ui-file-icon",color:n?"#121212":"rgba(255,255,255,0.851)",onClick:s,size:"small"}),l&&r.createElement(Ya,{className:n?"files-ui-file-icon dark-mode":"files-ui-file-icon",onClick:u,color:n?"#121212":"rgba(255,255,255,0.851)",size:"micro"})))))},Ct=function(e){var n=e.style,i=e.className,a=e.file,t=e.name,l=e.size,o=e.type,s=e.id,u=e.valid,c=e.errors,m=e.uploadStatus,g=e.uploadMessage,p=e.progress,b=e.xhr,h=e.localization,E=e.preview,k=e.imageUrl,L=e.videoUrl,N=e.info,f=e.backgroundBlurImage,w=f===void 0?!0:f,v=e.darkMode,x=e.alwaysActive,y=x===void 0?!0:x,F=e.resultOnTooltip,O=F===void 0?!0:F,j=e.downloadUrl,R=e.onDelete,M=e.onCancel,I=e.onAbort,_=e.onDownload,T=e.onSee,$=e.onWatch,A=e.onDoubleClick,D=e.onClick,q=e.onRightClick,ne=e.smartImgFit,J=ne===void 0?"orientation":ne,V=r.useContext(rt),U=V.darkMode,K=V.icons,X=V.localization,pe=h!==void 0?h:X,je=v!==void 0?v:U,Ne=r.useRef(null),ln=ue(ue("files-ui-file-mosaic-main-container files-ui-tooltip",i),D?"clickable":void 0),on=je?"files-ui-file-mosaic-file-name dark-mode":"files-ui-file-mosaic-file-name",ge=Ga(a,t,o,l),ie=ge[0],sn=ge[1],cn=ge[2],dn=ct(p,b),ee=lt(a,t,o,u,E,k,L,K),un=ee[0],fn=ee[1],mn=ee[2],Ce=ee[3],be=ee[4],pn=ee[5],Se=mi(cn),Fe=r.useState(!1),xe=Fe[0],Ie=Fe[1],Le=r.useState(!1),gn=Le[0],Oe=Le[1],bn=function(){y||Oe(!0)},xn=function(){y||Oe(!1)},hn=function(){return R==null?void 0:R(s)},vn=function(){return Ie(!0)},Me=function(){return Ie(!1)},le=st(m);r.useEffect(function(){le&&xe&&Me()},[le]);function yn(H){H.stopPropagation(),D==null||D(H)}var wn=function(H){H.preventDefault(),A==null||A(H)};function kn(H){q==null||q(H)}var zn=function(){var H=Ne.current;H&&H.click()},En=function(){_?_==null||_(s,j):typeof j=="string"&&zn()},jn=function(){b==null||b.abort(),I==null||I(s)};return un?r.createElement("div",{className:ln,style:n,onClick:yn,onMouseEnter:bn,onMouseLeave:xn,onDoubleClick:wn,onContextMenu:kn},r.createElement(wt,{className:"files-ui-file-mosaic-icon-layer-container",style:n},r.createElement(te,{className:"files-ui-file-mosaic-image-layer blur",visible:w},r.createElement($e,{imageSource:be,url:Ce,fileName:ie,isBlur:!0,smartImgFit:!1})),r.createElement(te,{className:"files-ui-file-mosaic-image-layer",visible:!0},r.createElement($e,{imageSource:be,url:Ce,fileName:ie,isBlur:!1,smartImgFit:J})),r.createElement(te,{className:"files-ui-file-mosaic-main-layer",visible:!le&&!xe},r.createElement(Nt,{deleteIcon:R!==void 0,onDelete:hn,darkMode:je,valid:u,uploadStatus:m,localization:pe,sizeFormatted:Se,imageIcon:fn&&T!==void 0,onSee:function(){return T==null?void 0:T(be)},videoIcon:mn&&$!==void 0,onWatch:function(){return $==null?void 0:$(pn)},downloadIcon:_!==void 0||j!==void 0,onDownload:En,infoIcon:N!==void 0,onOpenInfo:vn,isActive:y||gn})),r.createElement(te,{className:"files-ui-file-mosaic-info-layer",visible:xe,onClick:Z},r.createElement(Et,{onCloseInfo:Me,valid:u,localization:pe,localName:ie,sizeFormatted:Se,localType:sn})),r.createElement(te,{className:"files-ui-file-mosaic-upload-layer",visible:le,onClick:Z},r.createElement(zt,{uploadStatus:m,progress:dn,onCancel:M?function(){return M==null?void 0:M(s)}:void 0,onAbort:I?jn:void 0,localization:pe}))),r.createElement("div",{className:on},r.createElement(kt,{fileName:ie})),r.createElement(vt,{open:O,uploadStatus:m,valid:u,errors:c,uploadMessage:g}),r.createElement(yt,{fileName:ie,anchorRef:Ne,downloadUrl:j})):r.createElement(r.Fragment,null)};z(`.fui-fullscreen-container {
  position: fixed;
  display: flex;
  align-items: center;
  justify-content: center;
