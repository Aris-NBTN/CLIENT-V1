...
.files-ui-file-mosaic-upload-layer .elevation-list .elevation-item span {
  ...
  line-clamp: 2;
  -webkit-box-orient: vertical;
}`);var zt=function(e){var n=e.uploadStatus,i=e.onCancel,a=e.onAbort,t=e.progress,l=e.localization,o=r.useRef(null),s=r.useRef(null),u=r.useState([void 0]),c=u[0],m=u[1];r.useEffect(function(){m(function(p){if(p[p.length-1]==="preparing"&&n==="uploading"){var b=se([],p,!0);return b[p.length-1]=n,se([],b,!0)}return se(se([],p,!0),[n],!1)})},[n]);var g=function(){var p=o.current,b=s.current;p===null||b===null||(b.style.top=0-(c.length-1)*132+"px")};return r.useEffect(function(){c.length>1&&g()},[c.length]),r.createElement("div",{className:"elevation-layer-container",ref:o},r.createElement("div",{className:"elevation-list",ref:s},c.map(function(p,b){switch(p){case"preparing":return r.createElement("div",{className:"elevation-item",key:b+1},r.createElement(gt,{onCancel:i,localization:l}));case"uploading":return r.createElement("div",{className:"elevation-item",key:b+1},r.createElement(ht,{onAbort:a,progress:t,localization:l}));case"error":return r.createElement("div",{className:"elevation-item",key:b+1},r.createElement(pt,{localization:l}));case"success":return r.createElement("div",{className:"elevation-item",key:b+1},r.createElement(bt,{localization:l}));case"aborted":return r.createElement("div",{className:"elevation-item",key:b+1},r.createElement(ft,{localization:l}));default:return r.createElement("div",{className:"elevation-item",key:b+1},r.createElement(mt,null))}})))},$e=function(e){var n=e.imageSource,i=e.url,a=e.fileName,t=e.card,l=e.isBlur,o=e.smartImgFit,s=r.useState(void 0),u=s[0],c=s[1],m=r.useState(!1),g=m[0],p=m[1];r.useEffect(function(){c(n||i)},[n,i]);var b=function(){p(!0),c(i)};return l?r.createElement(r.Fragment,null,!t&&!g&&n&&r.createElement(Ae,{src:u,alt:"blur ".concat(a),smartImgFit:!1})):r.createElement(r.Fragment,null,r.createElement(Ae,{onError:b,src:u,style:{borderRadius:"0px"},alt:"preview ".concat(a),smartImgFit:o}))};z(`.files-ui-file-item-status-container {
  text-align: center;
  font-size: 0.8rem;
  background-color: rgba(255, 255, 255, 0.8);
  display: flex;
