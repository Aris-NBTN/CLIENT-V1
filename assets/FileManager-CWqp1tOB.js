...
.files-ui-file-item-status-container.file-status-loading .uploading-text p.percentage {
  font-weight: 500;
}`);var rn=function(e){var n=e.valid,i=e.uploadStatus,a=e.localization,t=e.style,l=Q(a).status;return i==="success"?r.createElement("div",{className:"files-ui-file-item-status-container file-status-ok",style:t},r.createElement(Ka,{color:"#4caf50",size:"small",className:"status-icon"}),l.success):i==="error"||i==="aborted"?r.createElement("div",{className:"files-ui-file-item-status-container file-status-error",style:t},r.createElement(et,{color:"#f44336",size:"semi-medium",className:"status-icon"}),l.error):n!=null?n?r.createElement("div",{className:"files-ui-file-item-status-container file-status-ok",style:t},r.createElement(en,{color:"#4caf50",size:"small",className:"status-icon"}),l.valid):r.createElement("div",{className:"files-ui-file-item-status-container file-status-error",style:t},r.createElement(nn,{color:"#f44336",size:"small",className:"status-icon"}),l.denied):r.createElement(r.Fragment,null)},Et=function(e){var n=e.valid,i=e.localization,a=e.onCloseInfo,t=e.uploadStatus,l=e.localName,o=e.sizeFormatted,s=e.localType,u=Q(i),c=u.fullInfoLayer,m=c.name,g=c.size,p=c.type;return r.createElement(r.Fragment,null,r.createElement("div",{className:"files-ui-file-mosaic-info-layer-header"},r.createElement(qa,{color:"rgba(255,255,255,0.8)",onClick:a,colorFill:"black"}),r.createElement(rn,{valid:n,uploadStatus:t,localization:i})),r.createElement("div",{className:"heading"},m),r.createElement("div",{className:"label"},l),r.createElement("div",{className:"heading"},g),r.createElement("div",{className:"label"},o),r.createElement("div",{className:"heading"},p),r.createElement("div",{className:"label"},s))};z(`.filesui-file-item-size {
  box-sizing: border-box;
  font-size: 0.7rem;
